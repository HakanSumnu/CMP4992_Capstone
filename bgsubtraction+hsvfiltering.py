...
def detect_tennis_ball(frame):
    ...
    combined_mask = cv2.bitwise_and(fg_mask, color_mask)  # Combine background subtraction + color filtering
    ...
    return frame, ball_position, combined_mask
...
def main():
    ...
    while True:
        ...
        frame, ball_position, mask = detect_tennis_ball(frame)
        ...
        cv2.imshow('Tennis Ball Tracking with Background Subtraction & Kalman Filter', frame)
        cv2.imshow('Background Subtraction Mask', mask)
