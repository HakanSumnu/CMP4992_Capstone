...
DISTANCE_BETWEEN_ROBOT_INITIAL_AND_CAMERA = 10.0 # In cm. It should be added to line equation since we use right hand-side coordinate system, which causes robot's initisl point to stay at
